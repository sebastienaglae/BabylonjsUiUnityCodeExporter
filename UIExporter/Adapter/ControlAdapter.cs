...
{
	[Header("ReadOnly Debug Settings")]
	[ReadOnly]
	public ControlAdapter parent;
	[ReadOnly]
	public string uniqueID;
	[ReadOnly]
	public int hierchicalLevel;
	[ReadOnly]
	public CanvasExporterUtils.AlignmentHorizontal alignmentHorizontal;
	[ReadOnly]
	public CanvasExporterUtils.AlignmentVertical alignmentVertical;

	[Header("Cursor Settings")]
	[Tooltip("Gets or sets the cursor to use when the control is hovered")]
	public BabylonControl.CursorType hoverCursor;

	[Header("Focus Settings")]
	[Tooltip("Gets or sets a boolean indicating if the control can be focusable")]
	public bool isFocusInvisible;

	[Header("Main color Settings")]
	[Tooltip("Gets or sets foreground color")]
	public Color color = new Color(1, 1, 1, 1);
	[Tooltip("Gets or sets alpha value for the control (1 means opaque and 0 means entirely transparent)")]
	[Range(0, 1)]
	public float alpha = 1;

	[Header("Disable color Settings")]
	[Tooltip("Gets or sets background color of control if it's disabled")]
	...
	[Tooltip("Gets or sets a number indicating size of stroke we want to highlight the control with (mostly for debugging purpose)")]
	public float highlightLineWidth;
	[Tooltip("Gets or sets a boolean indicating that we want to highlight the control (mostly for debugging purpose)")]
