...
namespace PROJECT
{
	...
	public class ScrollViewAdapter : RectangleAdapter, IAdapter
	{
		[Header("Bar Settings")]
		[Tooltip("Gets or sets the bar background")]
		...
		[Tooltip("Gets or sets the size of the bar")]
		public float barSize;

		[Header("Bucket Settings")]
		[Tooltip("Gets the bucket height")]
		public float bucketHeight;
		[Tooltip("Gets the bucket width")]
		public float bucketWidth;

		[Header("Horizontal Settings")]
		[Tooltip("Gets the horizontal scrollbar")]
		[ReadOnly]
		...
		[ReadOnly]
		[Tooltip("Gets the vertical scrollbar")]
		...
		[Tooltip("Gets or sets the height of the thumb")]
		...
		[Tooltip("Freezes or unfreezes the controls in the window. When controls are frozen, the scroll viewer can render a lot more quickly but updates to positions/sizes of controls are not taken into account. If you want to change positions/sizes, unfreeze, perform the changes then freeze again")]
