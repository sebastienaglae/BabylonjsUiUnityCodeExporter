...
namespace PROJECT
{
    public class ButtonAdapter : RectangleAdapter, IAdapter
    {
        ...
        [ReadOnly] protected new Color highlightColor;

        [Header("Font Settings")] public string fontFamily = "arial";

        [Header("Image Settings")] [Tooltip("The image of the button")]
        ...
        private IEnumerator GetTextureRequest(string url)
        {
            ...
            else
            {
                ...
                imageComponent.sprite = Sprite.Create(texture, imageComponent.rectTransform.rect,
                    imageComponent.rectTransform.pivot);
            }
        }
    }
}